...
export const getParamPerNetwork = <T>(param: iParamsPerNetwork<T>, network: eNetwork) => {
  const { coverage, buidlerevm, tenderly, manta, mantaTestnet } = param as iEthereumParamsPerNetwork<T>;
  ...
  switch (network) {
    ...
    case eEthereumNetwork.tenderly:
      return tenderly;
    case eEthereumNetwork.manta:
      return manta;
    case eEthereumNetwork.mantaTestnet:
      return mantaTestnet;
...
export const getParamPerPool = <T>({ proto }: iParamsPerPool<T>, pool: SiO2Pools) => {
  switch (pool) {
    case SiO2Pools.proto:
      return proto;
    default:
      return proto;
  }
