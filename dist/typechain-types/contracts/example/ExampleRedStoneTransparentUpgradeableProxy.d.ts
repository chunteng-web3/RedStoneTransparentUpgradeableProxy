...
export interface ExampleRedStoneTransparentUpgradeableProxyInterface extends utils.Interface {
    functions: {
...
export interface ExampleRedStoneTransparentUpgradeableProxy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ExampleRedStoneTransparentUpgradeableProxyInterface;
