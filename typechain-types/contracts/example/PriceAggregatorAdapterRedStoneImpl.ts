...
export declare namespace RedStonePriceExtractor {
  ...
  export type TimedPriceStructOutput = [
    string,
    BigNumber,
    BigNumber,
    BigNumber
...
export interface PriceAggregatorAdapterRedStoneImplInterface
  ...
  encodeFunctionData(
    functionFragment: "MAX_TIMESTAMP_DIFFERENCE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "dataFeedIDs",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "extractPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "fallbackFixedPrices",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "latestTimedPrice",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "manualUpdatePrices",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setDataFeedIDs",
    values: [string[]]
  ): string;
  encodeFunctionData(
    functionFragment: "setFallbackFixedPrice",
...
export interface PriceAggregatorAdapterRedStoneImpl extends BaseContract {
  ...
  functions: {
    ...
    latestTimedPrice(
      asset: string,
      overrides?: CallOverrides
    ): Promise<[RedStonePriceExtractor.TimedPriceStructOutput]>;
  ...
  estimateGas: {
    ...
    extractPrice(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
