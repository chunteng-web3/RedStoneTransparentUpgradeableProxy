...
export interface ExampleRedStoneTransparentUpgradeableProxyInterface
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "_autoSetRedStonePayloadLength"
      | "_getRedStonePayloadLength"
      | "_getRedstonePriceExtractor"
      | "_setRedStonePriceExtractor"
      | "admin"
      | "aggregateValues"
      ...
      | "migrateFromNonUpgradeableContract"
      | "validateTimestamp"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "_autoSetRedStonePayloadLength",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_getRedStonePayloadLength",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_getRedstonePriceExtractor",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_setRedStonePriceExtractor",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "migrateFromNonUpgradeableContract",
  ...
  getEvent(
    nameOrSignatureOrTopic: "MigratedFromNonUpgradeableContract"
  ): EventFragment;
...
export type FailedInjectedExtractionEvent = TypedEvent<
  [string, string, BigNumber, BigNumber, boolean, string, string, string],
  FailedInjectedExtractionEventObject
>;

export type FailedInjectedExtractionEventFilter =
  TypedEventFilter<FailedInjectedExtractionEvent>;
...
export type MigratedFromNonUpgradeableContractEventFilter =
  TypedEventFilter<MigratedFromNonUpgradeableContractEvent>;
...
export interface ExampleRedStoneTransparentUpgradeableProxy
  ...
  filters: {
    ...
    "FailedInjectedExtraction(string,address,uint256,uint256,bool,bytes,bytes,bytes)"(
      message?: null,
      redStonePriceExtractor?: null,
      redStonePayloadLength?: null,
      msgDataLength?: null,
      delegatedCallResult?: null,
      _calldata?: null,
      _redStonePayload?: null,
      delegatedReturnedData?: null
    ): FailedInjectedExtractionEventFilter;
    FailedInjectedExtraction(
      message?: null,
      redStonePriceExtractor?: null,
      redStonePayloadLength?: null,
      msgDataLength?: null,
    ...
    "MigratedFromNonUpgradeableContract(address,bytes[],string)"(
      nonUpgradeableContract?: null,
      args?: null,
      message?: null
    ): MigratedFromNonUpgradeableContractEventFilter;
    MigratedFromNonUpgradeableContract(
      nonUpgradeableContract?: null,
      args?: null,
      message?: null
    ): MigratedFromNonUpgradeableContractEventFilter;
